...
import { ArrowRight, Users, Thermometer, Zap } from 'lucide-react';
import { Button } from '@/components/ui/button';
import { toast } from '@/components/ui/use-toast';
import categories from '@/data/categories.json';

const Saunas = () => {
  const category = categories.find(c => c.id === 'saunas');
  ...
  return (
    <>
      <Helmet>
        <title>Premium Saunas | {category.title}</title>
                  ...
                  <div className="p-8">
                    ...
                    <div className="grid grid-cols-3 gap-4 mb-6">
                      <div className="text-center">
                        ...
                        <p className="text-[#F5F5F2] font-semibold">{model.capacity}</p>
                        <p className="text-[#C9CBD1] text-sm">People</p>
                      </div>
                      <div className="text-center">
                        <Thermometer className="w-6 h-6 text-[#C9A968] mx-auto mb-2" />
                        <p className="text-[#F5F5F2] font-semibold">{model.heaterType}</p>
                        <p className="text-[#C9CBD1] text-sm">Heater</p>
                      </div>
                      <div className="text-center">
